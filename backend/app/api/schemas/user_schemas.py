...
class UserBase(BaseModel):
    ...
    pnr: Optional[str] = Field(None, min_length=1, max_length=255, description="User's personal number")
    ...
    username: str = Field(
        ...
        min_length=4,
        max_length=255,
        description="User's username (minimum 4 characters)",
    )
...
class UserUpdate(BaseModel):
    ...
    username: Optional[str] = Field(None, min_length=4, max_length=255)
